/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 53d8d3611407c59a62902e71eb3c8044)
// Runtime types generated with workerd@1.20260623.1 2025-11-28 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS_BASE_URL: "https://assets.medowo.net";
	DIRECT_DOMAINS: "medowo.net";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASSETS_BASE_URL" | "DIRECT_DOMAINS" | "CLOUDFLARE_API_TOKEN">> {}
}
declare module "*.yaml" {
	const value: string;
