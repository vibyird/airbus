/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 19d34ab2626675adc6b0474f91bdd4e8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIRECT_DOMAINS" | "CLOUDFLARE_API_TOKEN">> {}
}
declare module "*.yaml" {
	const value: string;
