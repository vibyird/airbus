/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 666db7b0fe611f389ce458401e52f016)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DIRECT_DOMAINS">> {}
}
declare module "*.html" {
	const value: string;
